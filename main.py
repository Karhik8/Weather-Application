...
api_key = "3259f653fd5828657ccf569b3a7f4fe9"
...
def get_weather(city):
    ...
    location_response = requests.get(GEOCODING_API_ENDPOINT, location_params)
    ...
    return render_template("city.html", city_name=city_name, current_date=current_date, current_temp=
                           current_temp, current_weather=current_weather, min_temp=min_temp, max_temp=max_temp,
                           wind_speed=wind_speed, five_day_temp_list=five_day_temp_list, five_day_weather_list=
                           five_day_weather_list, five_day_dates_list=five_day_dates_list)
